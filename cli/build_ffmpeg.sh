...
#    curl "http://downloads.xiph.org/releases/vorbis/libvorbis-1.3.4.tar.gz" -o libvorbis-1.3.4.tar.gz
...
# Build libx264.
printf "copying libx264\n"
cp -R ${DIR_NDK}/sources/x264/android/arm/lib/ ${DIR_SYSROOT}/lib/
cp -R ${DIR_NDK}/sources/x264/android/arm/include/ ${DIR_SYSROOT}/include/

printf "    done\n    "
# libx264.a finished building.
...
./configure \
    ...
    --extra-ldflags="-lx264 -L${DIR_SYSROOT}/lib ${PIE_FLAGS}" \
